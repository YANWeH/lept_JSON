/*************************************************************************
	...
	> Created Time: Fri 15 Jul 2022 04:04:44 AM EDT
 ************************************************************************/
...
static void test_parse_object()
{
    ...
    EXPECT_EQ_STRING("o", lept_get_object_key(&v, 6), lept_get_object_key_length(&v, 6));
    {
        ...
        for(i = 0; i < 3; ++i)
        {
            ...
            EXPECT_TRUE((char)('1' + i) == lept_get_object_key(o, i)[0]);
...
static void test_parse_invalid_value()
{
    ...
    TEST_PARSE_ERROR(LEPT_PARSE_INVALID_VALUE, ".123");
    TEST_PARSE_ERROR(LEPT_PARSE_INVALID_VALUE, "1.");
...
static void test_parse_root_not_singular()
{
    ...
    /*invalid number*/
    TEST_PARSE_ERROR(LEPT_PARSE_ROOT_NOT_SINGULAR, "0123");
...
static void test_parse_invalid_unicode_hex()
{
    ...
    TEST_PARSE_ERROR(LEPT_PARSE_INVALID_UNICODE_HEX, "\"\\u00/0\"");
